...
struct PacketStats {
    ...
    void printToConsole() {
        ...
        printf("\tEvil packet count:     %i                     \n", g_evilPacketCount);
		printf("\t(%i seconds elapsed)\n                                                   \n", g_duration);
		printf("Analyzing packets... (hit RETURN to save and exit\n");
		fflush(stdout);
    }
};
PacketStats stats;
...
int main(int argc, char** argv) {
	...
	statfile << "Duration of capture:   " << g_duration << " seconds\n\n";
